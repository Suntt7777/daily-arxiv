...
### [1] [Stochastic Safety Limits and Scale-Dependent Power Fluctuations in Nuclear Reactors: A Critical Scaling Approach](https://arxiv.org/abs/2605.15283)
*V. V. Ryazanov*
...
### [2] [Solving Classical and Quantum Spin Glasses with Deep Boltzmann Quantum States](https://arxiv.org/abs/2605.15899)
...
### [3] [Machine learning potential as a guide for eutectic in ultra-refractory multicomponent ceramics](https://arxiv.org/abs/2605.16091)
...
### [4] [Sampling pseudospectrum for data-driven matrices](https://arxiv.org/abs/2605.15234)
*Caroline Wormell*
...
### [5] [Proposal-Guided Greedy Surrogate Refinement for PDE-Driven High-Dimensional Rare-Event Estimation](https://arxiv.org/abs/2605.15356)
...
### [6] [Implicit Dynamical Tensor Train Approximation for Kinetic Equations with Stiff Fokker--Planck Collisions](https://arxiv.org/abs/2605.15382)
...
### [7] [Amortized Energy-Based Bayesian Inference](https://arxiv.org/abs/2605.15407)
...
### [8] [A Model of a Buoyancy-Driven Heat Exchanger, with Implications for Optimal Design](https://arxiv.org/abs/2605.15409)
...
### [9] [Method of Fundamental Solutions for Maxwell's Equations in Bi-Periodic Multilayered Media](https://arxiv.org/abs/2605.15527)
...
### [10] [Entropy stable finite difference schemes for One-Fluid Two-Temperature Euler Non-equilibrium Hydrodynamics](https://arxiv.org/abs/2605.15616)
...
### [11] [A Tearing and Interconnecting Formulation for Magneto-Quasi-Statics](https://arxiv.org/abs/2605.15636)
*Clemens Pechstein*
...
### [12] [Adaptive Artificial Anti-Diffusion Methods for Hyperbolic Systems of Conservation Laws](https://arxiv.org/abs/2605.15770)
...
### [13] [Endpoint-singularity-preserving spectral approximation theory for weakly singular integral equations](https://arxiv.org/abs/2605.15825)
*Mahmoud A. Zaky*
...
### [14] [A note on short and long exact sequences in the BBG construction of complexes from complexes](https://arxiv.org/abs/2605.15933)
...
### [15] [On the Convergence of a Spline Collocation Method for Nonlinear Fractional Boundary Value Problems with the Riesz-Caputo Operator](https://arxiv.org/abs/2605.16102)
...
### [16] [Non-Relativistic Spin-Orbit Interaction in Triplet Superconductors: Edelstein Effect and Spin Pumping by Electric Fields](https://arxiv.org/abs/2605.15610)
...
### [17] [Observation of flat-bottom U-shaped energy gap in high-Tc nickelate (La,Pr)3Ni2O7 thin films](https://arxiv.org/abs/2605.15703)
...
### [18] [Equidistant resonance jumps in superconducting coplanar resonators driven by Abrikosov vortices](https://arxiv.org/abs/2605.15751)
...
### [19] [Effective increase of a superconducting critical temperature in a high-entropy electron mixture](https://arxiv.org/abs/2605.15834)
*Viktoriia Kornich*
...
### [20] [Discrete Mixed Quantization](https://arxiv.org/abs/2605.16203)
*Qiaochu Ma*
