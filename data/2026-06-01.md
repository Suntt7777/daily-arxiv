...
### [2] [Algebraic and FFT-Based Methods for Discrete-Time Matrix Convolutions with Applications to Semi-Markov Models](https://arxiv.org/abs/2605.30379)
...
### [3] [Entropy-stable and energy-conservative fully-discrete finite element method for non-isothermal phase-field models](https://arxiv.org/abs/2605.30559)
...
### [4] [Lightning Plus Polynomial Approximation: Optimal Root-Exponential Convergence for Singular Functions in Corner Domains](https://arxiv.org/abs/2605.30796)
...
### [5] [A Multi-Invariant Preserving Discrete Gradient Methods](https://arxiv.org/abs/2605.30827)
...
### [6] [Magnetic Resonance Dynamics via Fractional Bloch Equation: a Hybrid Computational Framework](https://arxiv.org/abs/2605.30856)
...
### [7] [Structure-Informed Bounds on the Kronecker Rank of Block-Structured Matrices](https://arxiv.org/abs/2605.30908)
...
### [8] [A novel Chebyshev collocation method for elliptic -type differential equations with degenerate coefficient](https://arxiv.org/abs/2605.31055)
...
### [9] [Solving Coupled Tensor Equation $\mathcal{A} \ltimes \mathcal{X} =\mathcal{B}, \ \mathcal{X}\ltimes \mathcal{C}=\mathcal{D}$ using Semi-Tensor Products in the t-product](https://arxiv.org/abs/2605.31122)
...
### [10] [A holomorphic neural network framework for 3D boundary value problems governed by harmonic potentials](https://arxiv.org/abs/2605.31231)
...
### [11] [Stochastic bifurcation analysis via polynomial chaos: consistency and convergence of branch-approximating solutions](https://arxiv.org/abs/2605.31288)
...
### [12] [Cohomology of Finite Element Stokes Complexes on Alfeld Splits](https://arxiv.org/abs/2605.31348)
...
### [13] [Spectral density estimation for normal matrices](https://arxiv.org/abs/2605.31430)
...
### [14] [Spectral coarse spaces based on indefinite operators: the $H_k$-GenEO method](https://arxiv.org/abs/2605.31552)
...
### [15] [High Flux Asymptotics and Critical Phenomena for the Magnetic Laplacian](https://arxiv.org/abs/2605.30793)
...
### [16] [Resolvent Convergence and Patch Approximation for Subwavelength Guided Modes in Non-Periodic Systems of High-Contrast Resonators](https://arxiv.org/abs/2605.30951)
...
### [17] [The multiplicity of the laplacian eigenvalue 1 of a tree](https://arxiv.org/abs/2605.30982)
...
Abstract: Let $G$ be a connected, undirected simple graph. Denote by $L(G)$ the Laplacian matrix of $G$, and let $m_{G}(λ)$ be the multiplicity of an eigenvalue $λ$ of $L(G)$. When $G$ is a tree $T$ with $n \ge 6$ vertices, Tian et al. [Discrete Mathematics, 2026] proved that if $T$ is reduced and contains no pendant $P_3$, then \[ m_{T}(1) \le \frac{n-6}{4}, \] and they gave a complete characterization of the graphs for which equality holds.
  In this paper, we further investigate the above problem. Still assuming that $T$ is a tree with $n \ge 7$ vertices which is reduced and has no pendant $P_3$, we prove the following results. If $m_T(1) \neq \frac{n-6}{4}$, then \[ m_{T}(1) \le \frac{n-7}{4}, \] and we give a complete characterization of the graphs for which equality holds. If, moreover, $m_T(1) \neq \frac{n-6}{4}, \frac{n-7}{4}$, then \[ m_{T}(1) \le \frac{n-8}{4}, \] and we also give a complete characterization of the extremal graphs.

</details>


### [18] [Generic simplicity for self-adjoint operators under bounded potential perturbations](https://arxiv.org/abs/2605.31368)
...
### [19] [Ni-O hybridization-driven electronic reconstruction across the superconducting dome in an infinite-layer nickelate](https://arxiv.org/abs/2605.30752)
...
### [20] [Bending-like stress induced by solder joint under uniaxial tensile testing in 2G-HTS tapes: Impact and optimization approach](https://arxiv.org/abs/2605.30760)
...
### [21] [Terahertz Electrodynamics and Kinetic Inductance of Disordered Titanium-Vanadium Alloy Thin Films](https://arxiv.org/abs/2605.30847)
...
### [22] [What controls the superconducting dome of electron-doped FeSe?](https://arxiv.org/abs/2605.31459)
...
### [23] [Kohn-Luttinger Superconductivity of Weyl Fermi Arcs in PtBi$_2$](https://arxiv.org/abs/2605.31501)
