...
### [2] [Signatures of Gaussian superconducting fluctuations in nonlocal noise magnetometry](https://arxiv.org/abs/2605.18970)
*Dror Orgad*
...
### [3] [Nearly perfect Fermi surface nesting in hole-doped La$_3$Ni$_2$O$_7$ enables bulk superconductivity without pressure or strain](https://arxiv.org/abs/2605.19297)
...
### [5] [Secondary Collective Excitations in Intermediate to Strong-Coupling Superconductors](https://arxiv.org/abs/2605.20059)
...
### [6] [Banded non-Hermitian random matrices, neural networks, and eigenvalue degeneracies](https://arxiv.org/abs/2605.19072)
...
### [7] [Activation Functions, Statistics and Learning of Higher-Order Interactions in Restricted Boltzmann Machines](https://arxiv.org/abs/2605.19178)
...
### [8] [Diffusing diffusivity selects Pareto tail exponent in random growth with redistribution](https://arxiv.org/abs/2605.19464)
...
### [9] [Optimal Persistence Reveals Hidden Topology in Complex Energy Landscapes](https://arxiv.org/abs/2605.19785)
*LI Zhenpeng*
...
### [10] [Relativistic Saturation of Coulomb-Limited Electron Coherence](https://arxiv.org/abs/2605.20141)
*Yury A. Budkov*
...
### [11] [DG = FEM + flat elements, Part I: Diffusion](https://arxiv.org/abs/2605.19037)
...
### [12] [A Priori Error Analysis of a High-Order Selective Discontinuous Galerkin Method for Elliptic Interface Problems](https://arxiv.org/abs/2605.19039)
...
### [13] [Recovering Complex Unitary Eigenspaces from Real-Valued Embeddings](https://arxiv.org/abs/2605.19041)
...
### [14] [Sharp analysis of sketched least squares and randomized low-rank approximation](https://arxiv.org/abs/2605.19096)
...
### [15] [Assessing Finite Element Choice in Structural Topology Optimization and A Posteriori Error Estimation](https://arxiv.org/abs/2605.19441)
...
### [16] [A Unified Transmissibility-Based Interior Penalty DG Method for Heterogeneous and Anisotropic Diffusion](https://arxiv.org/abs/2605.19454)
...
### [17] [A Spline-based Physics-Informed Numerical Scheme: Accurate Smooth Solutions for Differential Equations](https://arxiv.org/abs/2605.19564)
...
### [18] [Graph Neural Networks for Community Detection in Graph Signal Analysis](https://arxiv.org/abs/2605.19733)
...
### [19] [When can a neural operator replace a coarse solve? Architectural principles for two-level preconditioning](https://arxiv.org/abs/2605.19867)
...
### [20] [Adaptive Reduced-Basis Trust-Region Methods for Defect Identification in Elastic Materials](https://arxiv.org/abs/2605.19896)
...
### [21] [Revisiting recursive methods for Dyson and Keldysh in NEGF: Part I](https://arxiv.org/abs/2605.19910)
...
### [22] [A dual-field structure-preserving mixed finite element discretization for incompressible Hall MHD equations](https://arxiv.org/abs/2605.19920)
*Yi Zhang*
...
### [23] [A second-order product-type implicit-explicit Runge-Kutta method preserving unit length and energy dissipation structures for gradient flows of vector fields](https://arxiv.org/abs/2605.19942)
...
### [24] [Scalable parallel 3-D TEM inversion via rational approximation of the matrix exponential](https://arxiv.org/abs/2605.19951)
...
### [25] [Quasi-optimal complexity of iterative Galerkin methods driven by an elliptic reconstruction error estimator](https://arxiv.org/abs/2605.20057)
...
### [26] [Reliable sampling-based RKHS norm estimation via superconvergence](https://arxiv.org/abs/2605.20091)
...
### [27] [A Novel Stochastic Particle-Field Algorithm for a Reaction-Diffusion-Advection Cancer Invasion Model](https://arxiv.org/abs/2605.20140)
