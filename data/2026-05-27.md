...
### [1] [Ultrametricity of Energy Minimum Configurations of RNA Secondary Structures in the Nussinov Model](https://arxiv.org/abs/2605.26570)
*A. P. Zubarev*
...
### [2] [Relationship between heat effects and shear modulus relaxation during structural relaxation of a telluride glass](https://arxiv.org/abs/2605.26767)
...
### [3] [The butterflies' effects](https://arxiv.org/abs/2605.27150)
*Siegfried Beckus*
...
Abstract: This work studies spectral properties of Schrödinger operators in the context of aperiodic order, using weighted Delone sets to explore the interplay between the underlying dynamics and spectral properties. We study parameter-dependent families interpolating between periodic and aperiodic regimes, whose spectra form so-called spectral butterflies. These reflect fractal and self-similar structures of the spectra.
  We review existing results, introduce additional examples, and establish new connections between works in the literature. The framework is largely dimension-independent and extends to non-Abelian groups and more general settings.
...
### [4] [Impact of Stoichiometry of MoSi Thin Films for Enhanced Sensitivity of Superconducting Nanowire Single-Photon Detectors](https://arxiv.org/abs/2605.27179)
...
### [5] [Electride States and Superconductivity in Dense Potassium Carbides](https://arxiv.org/abs/2605.27201)
...
### [6] [A Jacobi-like algorithm for normal matrices by the skew-symmetric part](https://arxiv.org/abs/2605.26317)
...
### [7] [Exact-curved Lagrange finite elements for the Poisson problem in two dimensions](https://arxiv.org/abs/2605.26566)
*Hiroki Ishizaka*
...
### [8] [Energy Dissipation Analysis of Implicit-Explicit Linear Multistep Methods for Gradient Flows Using a Simple Multiplier](https://arxiv.org/abs/2605.26592)
...
### [9] [An Unconditionally Linearly Convergent ADMM Approach for the Allen-Cahn Equation with Flory-Huggins Potential](https://arxiv.org/abs/2605.26623)
...
### [10] [FINOM: Fast Sinkhorn on Non-uniform Meshes](https://arxiv.org/abs/2605.26659)
...
### [11] [Predictive Moving Sample Method for Physics-Informed Neural Solvers of Time-Dependent PDEs](https://arxiv.org/abs/2605.26745)
...
### [12] [Generalized fractional Laguerre orthogonal functions: projection and interpolation estimates](https://arxiv.org/abs/2605.26832)
*Mahmoud A. Zaky*
...
### [13] [On the convergence of iterated penalty methods for structure-preserving discretizations of saddle point problems](https://arxiv.org/abs/2605.27069)
...
### [14] [A collocation scheme that is equivalent to discontinuous Galerkin discretizations](https://arxiv.org/abs/2605.27327)
*Jason Hicken*
