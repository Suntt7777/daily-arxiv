...
### [3] [A Hardware-aware Hopfield Network with a Nonlinear Memristor Array for Robust Associative Memory with Superlinear Capacity](https://arxiv.org/abs/2605.07223)
...
### [4] [Spectral Dynamics in Deep Networks: Feature Learning, Outlier Escape, and Learning Rate Transfer](https://arxiv.org/abs/2605.07870)
...
### [5] [Error estimation for numerical approximations of ODEs via composition techniques. Part II: BDF methods](https://arxiv.org/abs/2605.06735)
...
### [6] [Efficient symplectic integrators for cubic and quartic potentials](https://arxiv.org/abs/2605.06975)
...
### [7] [Accelerating the Simulation of Ordinary Differential Equations Through Physics-Preserving Neural Networks](https://arxiv.org/abs/2605.06980)
...
### [11] [Sparse Random-Feature Neural Networks with Krylov-Based SVD for Singularly Perturbed ODE](https://arxiv.org/abs/2605.07286)
...
### [12] [Convergence of an Eulerian scheme for the Vlasov-Poisson-BGK model](https://arxiv.org/abs/2605.07347)
...
### [13] [Solving Convolution-type Integral Equations using Preconditioned Neural Operators](https://arxiv.org/abs/2605.07365)
...
### [14] [Newton's method for optimal transport problem on graphs](https://arxiv.org/abs/2605.07408)
...
### [15] [Kolmogorov $\varepsilon$-entropy of numerical solutions for scalar conservation laws with convex flux](https://arxiv.org/abs/2605.07427)
...
### [16] [On structure-preserving and pointwise conservative continuous DG schemes for hyperbolic systems](https://arxiv.org/abs/2605.07576)
...
### [17] [NSPOD: acceleratingthe convergence ofKrylov-based iterative linearsolvers via approximated PODs](https://arxiv.org/abs/2605.07828)
...
### [18] [Invariant domain preserving limiting of time explicit and time implicit discretizations for systems of conservation laws](https://arxiv.org/abs/2605.08038)
...
### [19] [Necessary Conditions for Single-Critical-Point Higher-Order Szegő Sum Rules in OPUC](https://arxiv.org/abs/2605.06722)
*Daxiong Piao*
...
Abstract: We prove the necessity part of the higher-order Szegő theorem on the unit circle for the single-critical-point weights $H_m(e^{iθ})=(1-\cosθ)^m$, $m\ge1$. If $\{α_n\}_{n\ge0}$ are the Verblunsky coefficients of a nontrivial probability measure $dμ=w(θ)dθ/(2π)+dμ_{\mathrm s}$, then the weighted Szegő condition $\int_0^{2π}
  (1-\cosθ)^m\log w(θ)\frac{dθ}{2π}>-\infty$ implies $Δ^mα\in\ell^2,
  \,\,
  α\in\ell^{2m+2}.$
  The proof uses a finite-volume version of Yan's higher-order sum rule. The quadratic part yields the $m$-th difference energy, and the logarithmic tail yields the $\ell^{2m+2}$-control. The non-sign-definite critical terms are treated in two steps. First, the quartic principal critical block is isolated using the Yan quotient-algebra normal representative and shown to have a positive semidefinite Gram representation. Second, the remaining non-principal critical terms are controlled by the diagonal-vanishing property $\mathcal Y_{k,\mathrm{crit}}^{(m)}
  \in
  \mathfrak I_k^{\,m+1-k},
  \,\, 2\le k\le m,$ together with the Breuer--Simon--Zeitouni normal form, discrete interpolation, and Young's inequality. These estimates yield a uniform finite-volume coercive bound, from which the necessity theorem follows for all $m\ge1$.

</details>


### [20] [On the Spectral Region of 4-Cycle Stochastic Matrices](https://arxiv.org/abs/2605.06743)
