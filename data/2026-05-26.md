...
### [2] [Spectral analysis and sine transform based preconditioning for a structure preserving stabilized scheme approximating the space-fractional Allen Cahn equation with logarithmic potential](https://arxiv.org/abs/2605.24387)
...
### [3] [Geometry-Preserving Nudged Elastic Band and Dimer Methods under Anisotropic Force Uncertainty](https://arxiv.org/abs/2605.24401)
...
### [4] [Incremental SVD for Large-Scale Dynamic Matrices: Accuracy, Subspace Stability, Refresh Strategies, and Financial Factor-Based Risk Models](https://arxiv.org/abs/2605.24514)
*Stilyan Staykov*
...
### [5] [Optimized multilevel Monte Carlo methods in Banach spaces](https://arxiv.org/abs/2605.24620)
...
### [6] [WINO: A Weak-Form Physics Informed Neural Operator for Hyperelasticity on Variable Domains](https://arxiv.org/abs/2605.24651)
...
### [7] [Sharp Convergence Rates and Optimal Weights for Cimmino's Reflection Algorithm](https://arxiv.org/abs/2605.24692)
*Hemant Sharma*
...
### [8] [Efficient Numerical Schemes for a Two-Phase Hydrodynamical Model of Active Liquid Crystals and Solids](https://arxiv.org/abs/2605.24758)
...
### [9] [String kernel representations in elastostatics](https://arxiv.org/abs/2605.24827)
...
### [10] [A Hybrid Discontinuous Galerkin Method with Isogeometric-Planewaves Coupling for Periodic Full-Potential Electronic Structure Calculations](https://arxiv.org/abs/2605.24829)
...
### [11] [Shifted Matrix-Sign Reflectors for Prescribed-Index Eigenspace Reflection](https://arxiv.org/abs/2605.24840)
*Jin Zhao*
...
### [12] [IV-Net: A neural network for elliptic PDEs with random and highly varying coefficients](https://arxiv.org/abs/2605.24876)
...
### [13] [Simulation of Gaussian random fields on surfaces using the isogeometric finite element method](https://arxiv.org/abs/2605.24882)
...
### [14] [Convergence analysis of structure-preserving schemes for the multicomponent compressible Euler flows](https://arxiv.org/abs/2605.24898)
...
### [15] [Debiasing Random Oblique Projections for Subsampled OLS and Fast CUR in High Dimensions](https://arxiv.org/abs/2605.24955)
...
### [16] [A Guided Tour of Modern Domain Decomposition: From Schwarz Iterations to Robust Preconditioners and HPC Implementations](https://arxiv.org/abs/2605.24982)
...
### [17] [Randomized conjugate gradient least squares](https://arxiv.org/abs/2605.25034)
...
### [18] [Random Neural Network Expressivity for Non-Linear Partial Differential Equations](https://arxiv.org/abs/2605.25057)
...
### [19] [A quasi-orthogonal method based on the inverse operator for Schr{ö}dinger eigenvalue problems](https://arxiv.org/abs/2605.25149)
...
### [20] [Arnoldi-Enhanced Multivariate Hermite Interpolation of Manifold-Valued Data](https://arxiv.org/abs/2605.25176)
...
### [21] [Sampling Distributions as Regularization in Learned Inverse Problems](https://arxiv.org/abs/2605.25177)
...
### [22] [Computing weak-strong uniqueness of a Mach 2000 astrophysical jet](https://arxiv.org/abs/2605.25282)
...
### [23] [Atomistic-Continuum Coupling by Homogenization](https://arxiv.org/abs/2605.25286)
...
### [24] [Consistent CutPINNs for Elliptic PDEs on Curved Level-Set Domains](https://arxiv.org/abs/2605.25562)
*Maneesh Kumar Singh*
...
### [25] [A Jacobi-Type Eigensolver for Diagonally Dominant Symmetric Matrices](https://arxiv.org/abs/2605.25613)
*Luca Gemignani*
...
### [26] [Tensor train methods for high-dimensional nonlinear filtering problems with correlated noise](https://arxiv.org/abs/2605.25677)
...
### [27] [A multilevel sketch-and-solve method for overdetermined least squares problems](https://arxiv.org/abs/2605.25809)
...
### [28] [Branched Signature Kernel Solvers for ODEs with rough Single-Trajectory signals](https://arxiv.org/abs/2605.25826)
...
### [29] [Well-Balanced Schemes for Hyperbolic Kinetic Relaxation](https://arxiv.org/abs/2605.25887)
...
### [30] [Dynamic inverse problems: Online regularisation theory](https://arxiv.org/abs/2605.26022)
...
### [31] [A Dynamic Subspace Approach for Low-rank Approximation of Large-scale Nonlinear Systems](https://arxiv.org/abs/2605.26025)
...
### [32] [Fast Quadratic Manifold Learning For Nonlinear Dimensionality Reduction in Large-scale Systems using Riemannian Optimization](https://arxiv.org/abs/2605.26039)
...
### [33] [A Fully Discrete Energy-Based Discontinuous Galerkin Method for Variable-Order Time-Fractional Wave Equations](https://arxiv.org/abs/2605.26054)
*Lu Zhang*
...
### [34] [Quantum Domain Decomposition for Preconditioning the Finite Element Method](https://arxiv.org/abs/2605.26090)
...
### [35] [Emergence of Triplet Superconductivity from Cavity Vacuum Fluctuations](https://arxiv.org/abs/2605.24439)
...
### [36] [Synchronization of Bloch Oscillations in array of parallel Josephson Junctions](https://arxiv.org/abs/2605.24522)
...
### [37] [Nonunitary triplet superconductivity in the Z2 topological metal SrPd2As2](https://arxiv.org/abs/2605.24536)
...
### [38] [Light-Driven Intrinsic Perfect Superconducting Diode Effect](https://arxiv.org/abs/2605.25197)
...
### [39] [Nitrogen-doped W0.75Re0.25 Superconducting Nanowire Single Photon Detectors](https://arxiv.org/abs/2605.25597)
...
### [40] [Superconductivity and electronic structure evolution in the enforced semimetal Fe-doped ZrTe$_2$](https://arxiv.org/abs/2605.25898)
...
### [41] [Substitution modulated transition from semimetal to superconductor in ZrTe$_{2-x}$Se$_x$ with coexistence of nontrivial electronic topology](https://arxiv.org/abs/2605.25906)
...
### [42] [Exact Single-Scale Outer Solution of the Abrikosov Vortex in the Extreme Type-II Limit](https://arxiv.org/abs/2605.25938)
*Eugene B. Kolomeisky*
...
### [43] [Topological metal-insulator transitions in one-dimensional non-Hermitian quasicrystals: beyond PT-symmetry](https://arxiv.org/abs/2605.25072)
...
### [45] [Sum rules and a second order Feynman-Hellman theorem for abstract operators with applications](https://arxiv.org/abs/2605.24694)
*Joachim Stubbe*
