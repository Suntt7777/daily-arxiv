...
### [1] [A Complete Spectral Analysis of the CEV Operator with Applications to Arbitrage](https://arxiv.org/abs/2605.23009)
*Filippo Beretta,Florian Kogelbauer*
...
### [2] [Randomly twisted transfer operators and singular values statistics](https://arxiv.org/abs/2605.23530)
*Frédéric Naud*
...
### [3] [Phase diagram of the vortex state in an amorphous Re6Zr thin film exhibiting inverse melting](https://arxiv.org/abs/2605.23567)
...
### [4] [Disorder-Induced Phase Transitions in Altermagnetic Josephson Junctions](https://arxiv.org/abs/2605.23607)
*Chang-An Li*
...
### [5] [Quantum critical collapse of a pinned vortex glass](https://arxiv.org/abs/2605.23838)
...
### [7] [Mode-Shape Expansion Using Physics-Constrained Gaussian Process Regression](https://arxiv.org/abs/2605.23101)
*Farid Ghahari*
...
### [8] [High-order Conservative Discontinuous Galerkin Methods via Implicit Penalization for the Generalized Korteweg-de Vries Equation and the Hirota-Satsuma KdV System](https://arxiv.org/abs/2605.23181)
...
### [9] [Fourier--Galerkin Methods for Subwavelength Resonances in 2D Acoustic Metamaterials](https://arxiv.org/abs/2605.23251)
*Jinghao Cao*
...
### [10] [A matrix-based spectral method for the numerical approximation of the fractional Laplacian and the fractional $p$-Laplacian of functions defined on $\mathbb R^n$](https://arxiv.org/abs/2605.23252)
...
### [11] [High-order, long-time stable and parallel decoupled GBDF$k$ SAV ensemble schemes for the Navier--Stokes--Darcy flow with random hydraulic conductivity tensors](https://arxiv.org/abs/2605.23290)
...
### [12] [Geometric properties of the Lebesgue function](https://arxiv.org/abs/2605.23299)
...
### [13] [Nonconforming Finite Element Approximation and Energy Lower Bound Estimation for the Gross--Pitaevskii Energy Functional](https://arxiv.org/abs/2605.23334)
...
### [14] [Key challenges and bridges among convergence analysis techniques for polytopal methods](https://arxiv.org/abs/2605.23405)
...
### [15] [A high-order nodally bound-preserving and mass-conservative method for linear fourth-order elliptic problems and its applications to nonlinear parabolic equations](https://arxiv.org/abs/2605.23486)
...
### [16] [Spectral distribution of Jacobi weighted histopolation matrices via GLT theory](https://arxiv.org/abs/2605.23501)
...
### [17] [On the treatment of topology changes on 3D polyhedral moving meshes via 4D space-time hole-like elements in direct ALE ADER-DG methods](https://arxiv.org/abs/2605.23506)
...
### [18] [Accelerating an ensemble of variational data assimilations with randomized preconditioning](https://arxiv.org/abs/2605.23571)
...
### [19] [Mixed-Precision in adaptive Runge-Kutta method for large ODE systems](https://arxiv.org/abs/2605.23727)
